...
def resolve_data_path(explicit_path=None):
	...
	Checks in order: explicit path > NEXTGENFACE_DATA_DIR env var >
...
class Config:
	def __init__(self):
		...
		self.iterStep3 = 500 #number of iterations for refining the statistical albedo priors
		...
		self.rtSamples = 10000 #the number of ray tracer samples to render the final output
